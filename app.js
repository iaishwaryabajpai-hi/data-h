...
const C = {
    primary: '#111111',
    primaryA: 'rgba(17,17,17,0.2)',
    male: '#444444',
    maleA: 'rgba(68,68,68,0.3)',
    female: '#888888',
    femaleA: 'rgba(136,136,136,0.3)',
    cyan: '#555555',
    cyanA: 'rgba(85,85,85,0.15)',
    green: '#222222',
    greenA: 'rgba(34,34,34,0.25)',
    amber: '#666666',
    violet: '#777777',
    grid: 'rgba(0,0,0,0.1)',
};
...
const BASE = {
    ...
    plugins: {
        ...
        legend: { labels: { color: '#333333', usePointStyle: true, font: { size: 12, family: "'Lora', serif" } } },
        tooltip: {
    ...
    scales: {
        y: {
            ...
            ticks: { color: '#555', font: { size: 11, family: "'Lora', serif" } }
        },
        x: {
            grid: { display: false },
            ticks: { color: '#555', font: { size: 11, family: "'Lora', serif" } }
    ...
    new Chart(document.getElementById('familyChart'), {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: ['#111111', '#444444', '#777777', '#aaaaaa', '#dddddd'],
        ...
        options: {
            ...
            cutout: '68%',
            plugins: {
                legend: { position: 'right', labels: { color: '#333', font: { size: 11, family: "'Lora', serif" }, padding: 14, usePointStyle: true } },
                datalabels: { display: false },
